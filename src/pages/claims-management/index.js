...
<div className="relative overflow-x-auto">
    <table className="w-full text-sm text-left text-gray-500 bordered">
      ...
      {modalOpen && (
        <PolicyModal onClose={handleModalClose}>
          ...
          <div className="mb-6">
    <label htmlFor="newPolicyName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Claim Name</label>
  ...
  <div className="mb-6">
    <label htmlFor="newPolicyType" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Claim Type</label>
  ...
  <div className="mb-6">
    <label htmlFor="newPolicyPremium" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Claim </label>
